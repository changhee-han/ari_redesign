        ...
        <div class="section hero_banner">
            ...
            while (have_rows('hero_banner')) : the_row(); ?>
                ...
                <div class="hero_banner_bg"
                     style="background: linear-gradient(rgba(0,0,0,.4), rgba(0,0,0,.4)), url('<?php the_sub_field('hero_banner_background_media'); ?>') no-repeat; background-size: cover;">
    ...
    if (have_rows('article_banner')):
        ...
        while (have_rows('article_banner')) : the_row(); ?>
            ...
            <?php if (get_sub_field('article_banner_display_on_off')): ?>
                ...
                <?php
                //global $post;
                $args = array('posts_per_page' => 1, 'category_name' => $category[$i], 'orderby' => 'date', 'order' => 'ASC');

                $lastposts = get_posts($args);
                foreach ($lastposts as $post) :
                    setup_postdata($post); ?>
                    <div class="article_box">
                        <h2><?php the_sub_field('article_section_headline'); ?></h2>
                        <div>
